      ...
      <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-10">
        ...
        <header className="space-y-6">
          ...
          <p className="max-w-[600px] text-lg text-gray-600 md:text-xl/relaxed xl:text-2xl/relaxed text-center">
            Meet our new AI chat companion that goes beyond conversation - it can actually get things done!
          </p>
        ...
        <SignedIn>
          <Link href="/dashboard">
              <button className="group relative inline-flex items-center              justify-center px-8 py-3.5 text-base font-medium text-white              bg-gradient-to-r from-gray-900 to-gray-800 rounded-full               hover:from-gray-800 hover:to-gray-700 transition-all duration-200              shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                  ...
                  <div className="absolute inset-0 bounded-full bg-gradient-to-r                  from-gray-900/20 to-gray-800/20 blur-xl opacity-0                  group-hover:opacity-100 transition-opacity" />
              </button>
          </Link>
        </SignedIn>
        <SignedOut>
